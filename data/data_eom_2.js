...
const data = {
            ...
            {"text":  `
                <table class="iksweb" style='width: 100%'>
                    <tbody>
                        ...
                        <tr>
                            <td style='font-weight: 700'>Наличие сильных электрических и магнитных полей может увеличить опасность</td>
                            <td>Чем дольше воздействие, тем тяжелее последствия</td>
                        </tr>
                    </tbody>
                </table>
    ...
    "index_4":{
        ...
        "test":[
            ...
            {"definitions": [
                ...
                "<p class='popup_zoom_plc zoom_paragraph'>Электрическое сопротивление изоляции фаз сети относительно земли</p>",
                "Емкость фаз сети относительно земли",
                "Режим нейтрали электрической сети",
                "Режим работы электрической сети"
            ]},
            {"answers": [
                "<p class='popup_zoom_plc zoom_paragraph'>Электрическое и магнитное поля.</p>",
                "<p class='popup_zoom_plc zoom_paragraph'>Величина напряжения прикосновения.</p>",
                "<p class='popup_zoom_plc zoom_paragraph'>Путь тока через тело человека.</p>",
                "<p class='popup_zoom_plc zoom_paragraph'>Продолжительность воздействия тока.</p>",
                "<p class='popup_zoom_plc zoom_paragraph'>Величина электрического тока, проходящего через тело.</p>",
                "<p class='popup_zoom_plc zoom_paragraph'>Электрическое сопротивление изоляции фаз сети относительно земли.</p>"
            ]},
            {"correct_answer_type_10": [3, 1, 2, 4, 5, 6]}
        ],
    },
    "index_5":{
        "subtitle": "Какие из следующих факторов влияют на исход поражения человека электрическим током? <br> <p class='black_sub'>(Выберите все правильные ответы)</p>",
    ...
    "index_10":{
        ...
        "test": [{
            ...
            "answers": ["Надеть диэлектрические перчатки", "Отключить электрооборудование", "Освободить пострадавшего от контакта с электрооборудованием или электрическими проводами", "Подложить под пострадавшего диэлектрический коврик", "Если в пределах видимости находятся все необходимые средства защиты, обязательно воспользоваться ими"]
        }],
    },
    "index_11":{
        "subtitle": "Изучите правила освобождения пострадавшего от действия электрического тока при напряжении cвыше 1000 В и эвакуации пострадавшего из зоны действия электрического тока.",
